 ...
 * </p>
 * 南钢外联ESB连通性探测服务
 * @author shijp 20221009
 * @E-Mail 
 */
public class DetectService_dmzesb implements IBusinessService {
private static final MyLog log = MyLogHelper.getFactory().getLog(DetectService_dmzesb.class);
